...
package org.alfresco.extension.versionsdiff.evaluator;
...
public class MimetypeSubComponentEvaluator extends DefaultSubComponentEvaluator {
    ...
    public boolean evaluate(RequestContext context, Map<String, String> params) {
        ...
        try {
            ...
            //final Response response = connector.call("/api/node/" + nodeRef.replace(":/", ""));
            final Response response = connector.call("/api/metadata?nodeRef=" +  nodeRef);
            if (response.getStatus().getCode() == Status.STATUS_OK) {

                //String mimetype = parseReponse(response);
                String mimetype = new JSONObject(response.getResponse()).getString("mimetype");
